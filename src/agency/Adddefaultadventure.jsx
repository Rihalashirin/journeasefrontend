...
let handleSubmit=async()=>{
    let response=await axios.put(`http://localhost:4000/agency/adddefaultadventure/${id}`,{defaultadventureId:selectedResorts})
    ...
    <div  className='bg-[#1a2954d6] h-screen'>
        <div className='h-[64px] font text-[30px] font-bold m-0 text-left pl-10 '>
            ...
            {adventureData.map((item)=>(
                <div className='bg-orange-600 w-[200px] ml-5 rounded-lg mt-5'>
