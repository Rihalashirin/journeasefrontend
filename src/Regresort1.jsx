...
export const Regresort1 = () => {
  ...
  let handleSubmit=async (event)=>{
     ...
     let response=await axios.post('http://localhost:4000/user/registration',data)
        ...
        <div className='flex w-[100%] justify-center sm:gap-10'>
          ...
          <div className='w-[25%]  '>
            ...
            <div className='mb-2'>
              ...
              <input  onChange={handleChange} value={data.luxury} name="luxury" type="checkbox" id="luxury" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" placeholder="" required />
              </div>
              <div className='flex gap-10 items-center '>

              <label for="standard" class="block mb-2 text-sm font-medium text-white dark:text-white">Standard:</label>
              <input  onChange={handleChange} value={data.standard} name="standard" type="checkbox" id="standard" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" placeholder="" required />
              </div>
              </div>
            </div>
            <div>
              <label for="rooms" class="block mb-2 text-sm font-medium text-white dark:text-white">No of Rooms Available-Luxury.:</label>
              <input  onChange={handleChange} value={data.roomsluxury} name="luxury" type="age" id="age" class="shadow-sm bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
            </div>
            <div>
              <label for="images" class="block mb-2 text-sm font-medium text-white dark:text-white">Add Images:</label>
              <input  onChange={handleChange} value={data.images} name="images" type="file" id="images" class="shadow-sm bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
            </div>
            <div>
              <label for="rooms" class="block mb-2 text-sm font-medium text-white dark:text-white">No of Rooms Available-Standard:</label>
              <input  onChange={handleChange} value={data.roomsstd} name="standard" type="number" id="rooms" class="shadow-sm bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
            </div>
            <div>
              <label for="image" class="block mb-2 text-sm font-medium text-white dark:text-white">Add Images:</label>
              <input  onChange={handleChange} value={data.imag} name="image" type="file" id="image" class="shadow-sm bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
            </div>
            {/* <div >
          ...
          <div className='w-[25%]'>
            ...
            <div >
              ...
              <input  onChange={handleChange} value={data.occupancyluxury} name="luxuryOccupancy" type="number" id="occupancy" class="shadow-sm bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="" required />
            </div>
            <div >
              ...
              <input  onChange={handleChange} value={data.occupancystd} name="standardOccupancy" type="number" id="occupancy" class="shadow-sm bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
            </div>
            <div >
              <label for="price" class="block mb-2 text-sm font-medium text-white dark:text-white">Price-Luxury :</label>
              <input  onChange={handleChange} value={data.priceluxury} name="luxuryPrice" type="number" id="price" class="shadow-sm bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
            </div>
            <div>
              <label for="price" class="block mb-2 text-sm font-medium text-white dark:text-white">Price-Standard:</label>
              <input  onChange={handleChange} value={data.pricestd} name="standardPrice" type="number" id="price" class="shadow-sm bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
            </div>
            {/* <div >
