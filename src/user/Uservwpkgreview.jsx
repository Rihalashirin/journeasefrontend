...
<div className='text-white font-bold text-xl font pt-4 pl-4'>The WeTrip Planners  Holiday Experience Process
</div>
<div className='bg-white'>Begin your remarkable journey with Travellers Planet from the moment you fill out our travel enquiry form.
One of our travel experts will get in touch with you to plan your all-inclusive vacation.
Work with a personal travel expert to design your own unique vacation from start to finish– an offering which is truly second to none.
You can choose from our large portfolio of extraordinary destinations, hand-picked hotels, exceptional tours and activities.
Your customised trip will provide you with the flexibility and privacy that is needed to completely enjoy your well-deserved break.

</div>
<div className='font-semibold font text-white pl-4 text-2xl pt-2 bg-orange-600 w-36 mt-4 m-auto'>why us</div>
<div className='flex flex-wrap gap-8 mt-3'>
<div className='bg-white '>asdfgghhjjj</div>
<div className='bg-white'>asdfgghhjjj</div>
<div className='bg-white'>asdfgghhjjj</div>
</div>
